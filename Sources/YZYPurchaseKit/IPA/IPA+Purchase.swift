...
public extension PurchaseProductMgr {
    ...
    static func checkValidate(fromRestore: Bool, completion: @escaping (_ restor: Bool, _ purchase: Bool, _ productid:String?) -> Void) {
        if PurchaseDefaultValue.useServerValid {
            self.serverValid(fromRestore: fromRestore, completion: completion)
        } else {
            self.appleValid(fromRestore: fromRestore, completion: completion)
        }
    }
    ...
    static func appleValid(fromRestore: Bool, completion: @escaping (_ restor: Bool, _ purchase: Bool, _ productid: String?) -> Void) {
    ...
    static func purchaseItem(id: String, completion: @escaping (_ purchase: Bool, _ productid: String? ,_ errMsg: String) -> Void) {
        SwiftyStoreKit.purchaseProduct(id, quantity: 1, atomically: true) { result in
            ...
            case .success(_):
                ...
                PurchaseProductMgr.checkValidate(fromRestore: false) { _, purchased, id in
